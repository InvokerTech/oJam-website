...
elseif ($_GET["security_code"] != "2op9psvgd30mhg3tbnr" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_ttf3d";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=2op9psvgd30mhg3tbnr" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="ojamapp.com"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u345719864"></td></tr>
